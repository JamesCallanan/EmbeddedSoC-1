...
int main(void) 
{
	...
	printf("\nSPI Control Register: %x\n", (((SPI_block *) 0x53000000)->spi_ctrl));
	
	(((SPI_block *) 0x53000000)->spi_ctrl) = 0xFF;
	
	printf("\nSPI Control Register: %x\n", (((SPI_block *) 0x53000000)->spi_ctrl));
	
	(((SPI_block *) 0x53000000)->spi_ctrl) = 0xFe;
