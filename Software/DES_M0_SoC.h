/* DES_M0_SoC.h
	...
	This version includes basic support for the NVIC and SysTick timer,
	so it can work without CMSIS.  */
...
typedef struct 
{
	...
	{
		volatile uint8   RxData;		// 1-byte register
...
typedef struct
{
	...
	volatile uint32	VAL;			// Currnet count value
} SysTick_block;
