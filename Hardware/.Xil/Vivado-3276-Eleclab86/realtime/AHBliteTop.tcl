...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-3276-Eleclab86/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog {
      ./.Xil/Vivado-3276-Eleclab86/realtime/CORTEXM0DS_stub.v
      ./.Xil/Vivado-3276-Eleclab86/realtime/blk_mem_4Kword_stub.v
      ./.Xil/Vivado-3276-Eleclab86/realtime/blk_mem_8Kword_stub.v
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-3276-Eleclab86/"
    if {$rt::useElabCache == false} {
